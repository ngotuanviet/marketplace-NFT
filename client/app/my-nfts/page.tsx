...
export default function MyNFTs() {
  ...
  async function resellNFT(tokenId: any, tokenPrice: any) {
    ...
    const signer = await provider.getSigner();
    const marketplaceContract = new ethers.Contract(contractAddress, NFTMarketplace.abi, signer);
    const price = ethers.parseUnits(tokenPrice.toString(), "ether");
    ...
    setToast({ open: true, message: "Ðã dang bán lại", severity: "success" });
    loadNFTs();
  }
  ...
  const filtered = useMemo(() => {
    ...
    return nfts
      ...
      .filter((nft) => {
        ...
        const isListed = nft.seller?.toLowerCase?.() === nft.owner?.toLowerCase?.();
        return status === "listed" ? isListed : !isListed;
      })
        ...
        <Grid item xs={6} md={3}>
          <FormControl fullWidth>
            ...
            <Select value={status} label="Status" onChange={(e) => setStatus(e.target.value)}>
              ...
              <MenuItem value="owned">Ðang sở hữu</MenuItem>
        ...
        <Grid item xs={6} md={2}>
          <FormControl fullWidth>
            ...
            <Select value={sort} label="Sort" onChange={(e) => setSort(e.target.value)}>
              ...
              <MenuItem value="price-asc">Giá tang dần</MenuItem>
        ...
        {!isLoading && paged.length === 0 && (
          <Grid item xs={12}>
            <Card sx={{ p: 4, textAlign: "center" }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Hãy tạo hoặc mua NFT đã hiện thị ở dây.
              </Typography>
            </Card>
          </Grid>
        )}
              ...
              <Card sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
                ...
                <CardActions sx={{ justifyContent: "space-between", px: 2, pb: 2 }}>
                  ...
                  <Box>
                    ...
                    <Button variant="contained" onClick={() => resellNFT(nft.tokenId, nft.price)}>
                      Resell
                    </Button>
                  </Box>
                </CardActions>
