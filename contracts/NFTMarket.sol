...
contract NFTMarketplace is ERC721URIStorage, AccessControl {
    ...
    constructor() ERC721("Metaverse Tokens","META"){
        ...
        // Teachers can also manage Students
        // Note: OpenZeppelin AccessControl allows only one admin role per role by default.
        // To allow Teachers to manage Students, we can set TEACHER_ROLE as the admin of STUDENT_ROLE.
        _setRoleAdmin(STUDENT_ROLE, TEACHER_ROLE);
    }
    ...
    function updateListingPrice(uint _listingPrice) public payable onlyRole(DEFAULT_ADMIN_ROLE){
    ...
    // Allow user to resell a token they have purchased

    function resellToken(uint256 tokenId,uint256 price) public payable{
        require(idToMarketItem[tokenId].owner == msg.sender,"Only items owner can perform this operation");
        require(msg.value == listingPrice,"Price must be equal to listing price");
